...
/** * Round the amount to a valid range for Binance payment address request
...
const getPaymentAddress = async (amount) => {
  ...
  const signature = createHmac("sha256", apiSecret)
    .update(queryString)
    .digest("hex");
  const url = `https://api.binance.com/sapi/v1/capital/payment/address?${queryString}&signature=${signature}`;
...
export default getPaymentAddress;
